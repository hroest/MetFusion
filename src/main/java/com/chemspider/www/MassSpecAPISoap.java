...
public interface MassSpecAPISoap extends java.rmi.Remote {
    ...
    /**
     * Return SDF containing records found by asynchronous search
     * operation. Security token associated with 'Service Subscriber' role
     * is required to get access to this operation.
     */
