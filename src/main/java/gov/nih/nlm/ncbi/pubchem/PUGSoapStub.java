...
public class PUGSoapStub extends org.apache.axis.client.Stub implements gov.nih.nlm.ncbi.pubchem.PUGSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/", "AID"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), int.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/", "GetVersion"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"), java.lang.Boolean.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
    ...
    private static void _initOperationDesc2(){
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/", "OutcomeFilter"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/", "AssayOutcomeFilterType"), gov.nih.nlm.ncbi.pubchem.AssayOutcomeFilterType.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
    ...
    public PUGSoapStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/", "AssayOutcomeFilterType");
            cachedSerQNames.add(qName);
            cls = gov.nih.nlm.ncbi.pubchem.AssayOutcomeFilterType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(AID)});
  ...
  throw axisFaultException;
    ...
    public gov.nih.nlm.ncbi.pubchem.AssayDescriptionType getAssayDescription(int AID, java.lang.Boolean getVersion) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(AID), getVersion});
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {strKey, idOptions, limits});
  ...
  throw axisFaultException;
    ...
    public java.lang.String inputAssay(int AID, gov.nih.nlm.ncbi.pubchem.AssayColumnsType columns, java.lang.String listKeyTIDs, java.lang.String listKeySCIDs, gov.nih.nlm.ncbi.pubchem.AssayOutcomeFilterType outcomeFilter) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(AID), columns, listKeyTIDs, listKeySCIDs, outcomeFilter});
