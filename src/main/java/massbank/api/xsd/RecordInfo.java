...
public class RecordInfo  implements java.io.Serializable {
    ...
    /**
     * Gets the info value for this RecordInfo.
     * 
     * @return info
     */
    ...
    /**
     * Sets the info value for this RecordInfo.
     * 
     * @param info
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://api.massbank/xsd", "RecordInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://api.massbank/xsd", "info"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
