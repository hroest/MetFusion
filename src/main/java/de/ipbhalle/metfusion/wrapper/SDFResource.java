/**
 * created by Michael Gerlich, Nov 12, 2012 - 5:56:19 PM
 */ 
...
public class SDFResource implements Resource, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6716346460203608821L;
     ...
     */
    public SDFResource(ExternalContext ec, String resourceName, String folder) {
    	this.extContext = ec;
