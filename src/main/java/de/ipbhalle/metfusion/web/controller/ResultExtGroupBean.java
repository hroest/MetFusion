/**
 * created by Michael Gerlich, Nov 11, 2010 - 10:07:20 AM
 */ 
...
public class ResultExtGroupBean extends ResultExtGroup{

		
		protected static final String DEFAULT_IMAGE_DIR = "xmlhttp/css/rime/css-images/";
		...
		protected List<ResultExtGroupBean> parentInventoryList;
		 ...
		 */
		public ResultExtGroupBean(String indentStyleClass,
		                            String rowStyleClass,
		                            StyleBean styleBean,
		                            String expandImage,
		                            String contractImage,
		                            List<ResultExtGroupBean> parentInventoryList,
		                            boolean isExpanded) {
		 ...
		 */
		public void addChildFilesGroupRecord(ResultExtGroupBean resultRowGroup) {
		 ...
		 */
		public void removeChildFilesGroupRecord(ResultExtGroupBean resultRowGroup) {
		    if (this.childResultRows != null && resultRowGroup != null) {
		        if (isExpanded) {
