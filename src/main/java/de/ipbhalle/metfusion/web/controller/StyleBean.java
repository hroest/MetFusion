...
public class StyleBean implements Serializable {
    ...
    protected ArrayList<SelectItem> styleList;

    protected HashMap<String, StylePath> styleMap;
    ...
    /**
     * Utility class to manage different cssPath and imageDir named
     */
