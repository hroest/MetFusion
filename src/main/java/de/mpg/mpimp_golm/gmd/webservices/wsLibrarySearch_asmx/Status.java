...
public class Status implements java.io.Serializable {
    ...
    public static final Status indefinite = new Status(_indefinite);
    public static final Status success = new Status(_success);
    public static final Status failure = new Status(_failure);
    public static final Status exception = new Status(_exception);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://gmd.mpimp-golm.mpg.de/webservices/wsLibrarySearch.asmx/", "Status"));
    }
    /**
